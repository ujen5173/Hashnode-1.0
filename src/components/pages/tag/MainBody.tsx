...
import TagPageHeader from "~/components/header/TagPageHeader";
...
const MainBody: FC<{ tagDetails: DetailedTag }> = ({ tagDetails }) => {
  ...
  const {
    ...
    isFetchingNextPage,
    hasNextPage,
  } = api.posts.getArticlesUsingTag.useInfiniteQuery(
    {
  ...
  const articles = useMemo(
    () => articlesData?.pages.flatMap((page) => page.posts),
    [articlesData],
  );
