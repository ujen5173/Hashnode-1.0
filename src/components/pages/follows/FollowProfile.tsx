...
const FollowProfileArea: FC<{
  ...
  return (
    <div className="w-full rounded-md border border-border-light bg-white p-6 dark:border-border dark:bg-primary md:w-1/4">
      ...
      {user.username === session?.user.username && (
        <Link
          href="/settings"
          className="btn-outline mb-4 inline-flex items-center gap-2"
        >
