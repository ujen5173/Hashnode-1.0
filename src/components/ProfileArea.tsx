...
const ProfileArea: FC<{
  ...
  return (
    <main className="container-full-main my-4 min-h-screen rounded-md border border-border-light bg-white px-4 py-6 dark:border-border dark:bg-primary md:px-12 md:py-14 md:py-8 lg:px-16 lg:py-10 lg:py-20 xl:px-28 xl:py-24">
