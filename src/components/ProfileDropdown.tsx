...
>(({ user, setOpened }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 top-full z-20 mt-2 w-56 rounded-md border border-border-light bg-gray-50 text-left shadow-lg shadow-primary dark:border-border dark:bg-primary"
    >
