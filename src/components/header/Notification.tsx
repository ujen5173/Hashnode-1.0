...
import NotificationLoading from "../loading/notificaton";
...
const Notification = () => {
  ...
  return user ? (
    <div className="relative">
      ...
      <div className="mt-1 w-full overflow-hidden rounded-lg border border-border-light shadow-lg dark:border-border md:w-[35rem]">
        <section className="sticky left-0 top-0 z-20 w-full bg-white p-4 pb-0 dark:bg-black">
        ...
        <section className="scroll-area h-[50vh] max-h-[700px] min-h-[400px] w-full flex-1 overflow-auto bg-white p-4 text-center dark:bg-black">
    ...
    <div className="scroll-area min-h-[19.25rem] overflow-auto px-4">
      <ManageData
        ...
        notificationData={{
          data: notifications,
          isLoading,
          type: NotificationTypesEnum.ALL,
        }}
      />
      {isLoading &&
        Array(6)
